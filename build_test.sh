...
yosys -p "synth_ice40 -top top -json build/mini_minecraft.json" mini_minecraft_pkg.sv gpu_dda.sv spi_lcd.sv tex_rom.sv top_test.sv trig_rom.sv vram.sv world_ram.sv
